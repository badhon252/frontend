window.addEventListener("load", () => {
    ...
    const clear_all_task = document.querySelector(".clear")
    ...
    form.addEventListener("submit", (e) => {
        ...
        task_input_el.type = 'textarea';

        //? Adding new tasks here.
