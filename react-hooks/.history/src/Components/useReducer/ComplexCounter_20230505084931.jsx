  ...
  return (
    <Fragment>
      ...
      <Button
        ...
        inc={"by 1"} dec ={text={"by 1"}}
      />
      <Button
        data={() => dispatch({ type: decreament, value: 1 })}
        
      />
      <h2>Count: {state.count2}</h2>
      <Button
        data={() => dispatch({ type: increament2, value: 2 })}
        text={" decreament by 2"}
      />{" "}
      <Button
        data={() => dispatch({ type: decreament2, value: 2 })}
        text={" decreament by 2"}
      />
    </Fragment>
  );
