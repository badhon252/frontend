...
function Form() {
  ...
  return (
    <>
        <form action="#">
        <Input_Ref type="text" placeholder="Enter your name" nameHandler={nameHandler} value={name} ref={nameRef} />
        <Input_Ref type="text" placeholder="Enter your email" emailHandler={emailHandler} value={email} ref={emailRef} />
