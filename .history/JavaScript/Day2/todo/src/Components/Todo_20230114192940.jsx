            ...
            {todos.map((todo, index)=>{
                ...
                <div className="task" >
                    <div className="content">
                        <input type="text" id="contentInpu" className="text" value={todo} onChange={handleEdit} key={uuidv4}/>
                    </div>
                    <div className="actions">
                        <button className="task_edit" onClick={()=>handleEdit(index)} readonly>Edit</button>
                        <button className="task_delete" onClick={()=>handleDelete(index)} readonly>Delete</button>
                    </div>
                </div>
                )
            })}
