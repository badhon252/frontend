...
export default function Todo() {
  ...
  return (
    ...
    <section className="todo">
        <form action="#" id="form">
            <div id="addSection">
                <input type="text" id="todoInput" placeholder="Type your todo here" value={item} onChange={handleChange}/>
            ...
            {todos.map((todo, index)=>{
                ...
                <div className="task" >
                    <div className="content">
                        <input type="text" id="contentInpu" className="text" value={todo} onChange={handleEdit} key={uuidv4} contentEditable />
                    </div>
